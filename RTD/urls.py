...
urlpatterns = [
    ...
    url(r'^(?P<e_source>[a-z0-9A-Z]+)/(?P<e_time_b>[0-9_]+)/$', views.data_source_time_b, name='data_source_time_b'),
    url(r'^(?P<e_source>[a-z0-9A-Z]+)/(?P<e_time_b>[0-9_]+)/(?P<e_time_f>[0-9_]+)/$',
        views.data_source_time_f, name='data_source_time_f'),
